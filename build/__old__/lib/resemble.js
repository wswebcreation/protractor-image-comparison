...
function resembleJS(fileOne, fileTwo, options) {
    ...
    function _copyPixel(px, offset, data) {
        ...
        px[offset + 1] = data.g;
        px[offset + 2] = data.b;
        px[offset + 3] = data.a * pixelTransparency;
    }
    function _copyGrayScalePixel(px, offset, data) {
        px[offset] = data.brightness;
        px[offset + 1] = data.brightness;
        px[offset + 2] = data.brightness;
        px[offset + 3] = data.a * pixelTransparency;
    }
    ...
    function _addBrightnessInfo(data) {
        data.brightness = _getBrightness(data.r, data.g, data.b);
    }
        ...
        _loop(height, width, function (verticalPos, horizontalPos) {
            ...
            if (ignoreRectangles) {
                for (rectagnlesIdx = 0; rectagnlesIdx < ignoreRectangles.length; rectagnlesIdx++) {
                    ...
                    if ((verticalPos >= currentRectangle.y) &&
            ...
            else if (ignoreAntialiasing && (_addBrightnessInfo(pixel1),
                _addBrightnessInfo(pixel2),
...
//# sourceMappingURL=resemble.js.map