 ...
 * @param {object}   options                         The options provided by this method
 ...
 * @param {string}   options.formatString            The name of the image in the format it needs to be
 * @param {boolean}  options.hideScrollBars          Hide the scrollbars
 *
 * @returns {Promise<{
