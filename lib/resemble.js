...
(function (root, factory) {
  ...
  // ADDED NEW
  var ignoreRectangles;
  var ignoreTransparentPixel;
  ...
  var resemble = function (fileData) {
    ...
    /**
     * NOT USED, HAVE OWN IMPLEMENTATION
     */
  ...
  resemble.compare = function (image1, image2, options, cb) {
    ...
    // ADDED NEW
    ignoreRectangles = opt.ignoreRectangles || null;
    ignoreTransparentPixel = opt.ignoreTransparentPixel || false;
