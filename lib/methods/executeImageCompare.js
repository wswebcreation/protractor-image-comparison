 ...
 * @param {boolean} debug                                  Debug the comparison with extra logging
 *
 * @return {Promise<{
 * 		fileName: string,
 * 		folders: {
...
export default async function executeImageCompare(folderOptions, fileName, compareOptions, debug) {
	...
	if (misMatchPercentage > compareOptions.saveAboveTolerance || debug) {
