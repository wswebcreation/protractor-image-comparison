 ...
 * @param {boolean}  isScreen                                      If the comparison needs to be done for a screen or not
 *
 * @return {Promise<{
 * 		fileName: string,
 * 		folders: {
 ...
 * }>}
 */
export async function executeImageCompare(executor, options, isScreen = false) {
	const {
		debug,
		devicePixelRatio,
		fileName,
