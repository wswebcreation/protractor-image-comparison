...
export default async function getEnrichedInstanceData(executor, options, instanceData, addShadowPadding = false) {
	...
	const addressBarShadowPadding = getAddressBarShadowPadding(
		platformName,
		browserName,
		nativeWebScreenshot,
	...
	const toolBarShadowPadding = getToolBarShadowPadding(platformName, browserName, options.toolBarShadowPadding, addShadowPadding);
